<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('welcome') }}">Netflix<span
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="" class="col-12 col-md-6 p-0 mt-1">
                <div class="input-group">
                    <input type="search" class="form-control bg-transparent border-0"
                        placeholder="Search for your favorite movies" aria-label="Search for your favorite movies"
            ...
            <ul class="navbar-nav ml-auto">
                @auth
                    <li class="nav-item mr-2"><a href="{{ route('movies.index', ['favorite' => 1]) }}"
                            ...
                            <div class="bg-primary text-white d-flex justify-content-center align-items-center"
                                ...
                                id="nav__fav-count" data-fav-count="{{ auth()->user()->movies_count }}">
