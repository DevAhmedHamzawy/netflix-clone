            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-white">
                        ...
                        @auth
                            <a href="#" class="btn btn-primary text-capitalize movie__fav-btn"><span
                                    class="far fa-heart movie__fav-icon movie-{{ $movie->id }} {{ $movie->is_favorite ? 'fw-900' : '' }}"
                                    data-movie-id="{{ $movie->id }}"
                                    data-url="{{ route('movies.toggle_favorite', $movie->id) }}"></span> add
                                to favorite</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary text-capitalize my-3"><i
                                    class="far fa-heart"></i> add to
                                favorites</a>
                        @endauth
                        ...
                        <div class="movie__details text-white">
                            ...
                            <div class="d-flex movie__cta">
                                <a href="{{ route('movies.show', $related_movie->id) }}"
                                    class="btn btn-primary text-capitalize flex-fill mr-2"><i class="fas fa-play"></i> watch
                                    now</a>
                                @auth

                                    <i class="far fa-heart {{ $related_movie->is_favorite ? 'fw-900' : '' }} fa-1x align-self-center movie__fav-icon movie-{{ $related_movie->id }}"
